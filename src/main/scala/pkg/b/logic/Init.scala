...
object Init:
  ...
  def init: Unit =
    ...
    val printsFolder = baseFolder + fs + "prints"
    ...
    setPropsFileProperty(baseFolder + fs + "protoflow.properties", "prints.folder", printsFolder)
...
*/
    ...
    IdGen(inIdsFilePathName("archivedDocumentId"))
